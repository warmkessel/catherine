...
class SlideViewController: UIViewController {
    let imageList = [UIImage(named: "slideshow/Photo1"), UIImage(named: "slideshow/Photo2"), UIImage(named: "slideshow/Photo3"), UIImage(named: "slideshow/Photo4"), UIImage(named: "slideshow/Photo5"), UIImage(named: "slideshow/Photo6"), UIImage(named: "slideshow/Photo7"), UIImage(named: "slideshow/Photo8"), UIImage(named: "slideshow/Photo9"), UIImage(named: "slideshow/Photo10"), UIImage(named: "slideshow/Photo11"), UIImage(named: "slideshow/Photo12"), UIImage(named: "slideshow/Photo13"), UIImage(named: "slideshow/Photo14"), UIImage(named: "slideshow/Photo15"), UIImage(named: "slideshow/Photo16"), UIImage(named: "slideshow/Photo17"), UIImage(named: "slideshow/Photo18"), UIImage(named: "slideshow/Photo19"), UIImage(named: "slideshow/Photo20"), UIImage(named: "slideshow/Photo21"), UIImage(named: "slideshow/Photo22"), UIImage(named: "slideshow/Photo23")]
    ...
    func playSound() {
        guard let url = Bundle.main.url(forResource: "pierre", withExtension: "mp3") else { return }
